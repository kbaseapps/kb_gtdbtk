...
# key of the returned map is the upa of the assembly object or the file name of the binned
# contig
...
def handle_binned_contigs(upa, mgu, target_dir):
    ...
    for (dirpath, dirnames, filenames) in os.walk(bin_file_dir):
        for fasta_file in filenames:
            ...
            safe_filename = uuid.uuid4()
            fasta_path = os.path.join(target_dir, safe_filename)
